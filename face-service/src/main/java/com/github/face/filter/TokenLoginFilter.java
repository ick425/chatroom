package com.github.face.filter;

import com.alibaba.fastjson2.JSON;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.face.login.entity.CustomUser;
import com.github.face.login.vo.LoginVo;
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try {
            ...
            Authentication authenticationToken =
                    new UsernamePasswordAuthenticationToken(loginVo.getPhone(), loginVo.getPwd());
            //调用方法
...
//                customUser.getSysUser().getPhone());
        String token = "";
