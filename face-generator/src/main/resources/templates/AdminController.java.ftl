...
import ${cfg.modulePackage}.request.${entity}AddRequest;
import ${cfg.modulePackage}.request.${entity}QueryRequest;
import ${cfg.modulePackage}.request.${entity}UpdateRequest;
